...
public class KafkaConfiguration {
    ...
    public NewTopic companyDeletionRequestedTopic(
            @Value("${app.kafka.topics.company-deletion-requested}") String topicName) {
        return new NewTopic(topicName, 1, (short) 1);
    }

    @Bean
    public NewTopic companyDeletionCompletedTopic(
            @Value("${app.kafka.topics.company-deletion-completed}") String topicName) {
        return new NewTopic(topicName, 1, (short) 1);
    }
